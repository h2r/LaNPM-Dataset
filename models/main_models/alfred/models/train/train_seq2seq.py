...
if __name__ == '__main__':
    ...
    parser.add_argument('--action_dims', help='number of dimensions for the action size', default=9, type=int)
    ...
    if not os.path.exists(os.path.join(args.pp_data, "%s.vocab" % args.pp_folder)) and not args.preprocess:
    ...
    # start train loop
    model.run_train(optimizer=optimizer)
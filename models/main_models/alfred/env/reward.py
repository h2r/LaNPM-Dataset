...
class GotoLocationAction(BaseAction):
    ...
    def get_reward(self, state, prev_state, expert_plan, goal_idx):
        ...
        #print('HERE!!!! ',  next_subgoal['objectId']) #added by ahmed
        ...
        with open(file_path, 'a+') as file:
                ...
                expression_result = str(curr_distance < self.rewards['min_reach_distance'])
                # Write the result to the file followed by a newline character
                file.write(expression_result + '\n')
        """
        
        if next_goal_object is None: #added by ahmed
        	done = False #added by ahmed
        else:
        #breakpoint()
